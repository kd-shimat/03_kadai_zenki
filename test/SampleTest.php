...
class SampleTest extends TestCase
{
    ...
    public function testPassword()
    {
        ...
        // 指定URLへ遷移 (Google)
        $driver->get('http://php/src/password.html');
        // テキストボックスの要素を取得
        ...
        //assert
        $this->assertEquals("入力されたユーザーIDは、test1です。", $element_text->getText());
        $this->assertEquals("入力されたパスワードは、test2です。", $element_password->getText());
    ...
    public function testPulldown()
    {
        ...
        $driver = RemoteWebDriver::create($host,DesiredCapabilities::chrome());
        // 指定URLへ遷移 (Google)
        $driver->get('http://php/src/pulldown.html');
        // プルダウンの値を取得
        ...
        //assert
        $this->assertEquals("あなたの好きなフルーツは、オレンジですね。", $element->getText());
